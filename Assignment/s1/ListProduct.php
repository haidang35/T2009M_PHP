...
<body>
    ...
    <div class="btn-add-new">
        <button onclick="location.href='AddNewProduct.php?id=<?php echo $id ?>'" class="btn btn-success btn-lg">Add new product</button>
    </div>
            ...
            <?php foreach ($listProduct as $key => $item) {?>
                <tr>
                    ...
                    <td class="item-button">
                        <button onclick="location.href='EditProduct.php?id=<?php echo $item["id"];?>'" type="button" class="btn btn-primary btn-lg">Edit</button>
                        <?php
                            if($item["quantity"] > 0) { ?>
                                <button onclick="location.href='AddToCart.php?id=<?php echo $item["id"];?>'" type="button" class="btn btn-success btn-lg">Add to cart</button>
                            <?php } else { ?>
